# Rich Display & 3D/SVG Templates

HiyoCanvas nodes can render rich output via display(). This document contains templates and rules for advanced display types.
